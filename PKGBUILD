...
pkgbase="mesa"
pkgname=('mesa' 'libgl' 'ati-dri' 'intel-dri' 'unichrome-dri' 'mach64-dri' 'mga-dri' 'r128-dri' 'savage-dri' 'sis-dri' 'tdfx-dri')
pkgver=7.8.1
pkgrel=1
arch=(i686 x86_64)
makedepends=('glproto>=1.4.11' 'pkgconfig' 'libdrm>=2.4.20' 'libxxf86vm>=1.1.0' 'libxdamage>=1.1.2' 'expat>=2.0.1' 'libx11>=1.3.3' 'libxt>=1.0.8' 'gcc-libs>=4.4.3' 'dri2proto=2.3' 'python')
...
package_libgl() {
  depends=('libdrm>=2.4.20' 'libxxf86vm>=1.1.0' 'libxdamage>=1.1.2' 'expat>=2.0.1')
...
package_mesa() {
  depends=('libgl' 'libx11>=1.3.3' 'libxt>=1.0.8' 'gcc-libs>=4.4.3' 'dri2proto=2.3' 'libdrm>=2.4.20')
