...
source=(#ftp://ftp.freedesktop.org/pub/mesa/${pkgver}/MesaLib-${pkgver}.tar.bz2
	ftp://ftp.freedesktop.org/pub/mesa/${pkgver/.0.901//}RC/MesaLib-${pkgver/0.901/1-rc1}.tar.bz2
        #ftp://ftp.freedesktop.org/pub/mesa/${pkgver}/MesaDemos-${pkgver}.tar.bz2
	ftp://ftp.freedesktop.org/pub/mesa/${pkgver/.0.901//}RC/MesaDemos-${pkgver/0.901/1-rc1}.tar.bz2
        ftp://ftp.archlinux.org/other/mesa/gl-manpages-1.0.1.tar.bz2
        mesa-7.1-link-shared.patch
        intel-revert-vbl.patch
        LICENSE)
md5sums=('d0f5622ac53b20b3761dd97c9788211f'
         'c0771e73648fd3cadeae998b80c7b89d'
...
build() {
 # cd "${srcdir}/Mesa-${pkgver}"
  cd "${srcdir}/Mesa-${pkgver/0.901/1-rc1}"
...
#  cd "${srcdir}/Mesa-${pkgver}" || return 1
  cd "${srcdir}/Mesa-${pkgver/0.901/1-rc1}" || return 1
...
#  cd "${srcdir}/Mesa-${pkgver}/src/mesa/drivers/dri" || return 1
  cd "${srcdir}/Mesa-${pkgver/0.901/1-rc1}/src/mesa/drivers/dri" || return 1
