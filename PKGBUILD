...
pkgrel=3
arch=(i686 x86_64)
makedepends=('glproto>=1.4.11' 'pkgconfig' 'libdrm>=2.4.20' 'libxxf86vm>=1.1.0' 'libxdamage>=1.1.2' 'expat>=2.0.1' 'libx11>=1.3.3' 'libxt>=1.0.8' 'gcc-libs>=4.5' 'dri2proto=2.3' 'python')
...
md5sums=('25ec15f8e41fde6d206118cc786dbac4'
         ...
         '8318654393ea5c1eda2df996f592372f'
         '5c65a0fe315dd347e09b1f2826a1df5a')

build() {
  cd "${srcdir}/Mesa-${pkgver}"
  patch -Np1 -i "${srcdir}/7.8-git-fixes.patch" || return 1
  autoreconf || return 1
