...
pkgrel=2
arch=(i686 x86_64)
makedepends=('glproto>=1.4.11' 'pkgconfig' 'libdrm>=2.4.18-3' 'libxxf86vm>=1.1.0' 'libxdamage>=1.1.2' 'expat>=2.0.1' 'libx11>=1.3.3' 'libxt>=1.0.7' 'gcc-libs>=4.4.3' 'dri2proto=2.1' 'python')
